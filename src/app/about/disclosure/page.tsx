...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "How SiteComms Australia works with installers and technology partners while keeping its guidance clear and transparent.",
  ...
  return (
    <div className="sc-container max-w-3xl py-16 sc-prose">
      ...
      <p className="mt-4 text-lg text-[var(--sc-slate)]">
        SiteComms Australia is an information and planning resource operated by T3 Labs. Where a user wants a formal quote, installation or site assessment, SiteComms may recommend one or more suitable providers and give the user those providers&apos; public contact details.
      </p>
      <h2>How provider recommendations work</h2>
      <p>
        Using a provider suggested by SiteComms is optional. Customers are free to use any provider they choose. SiteComms reviews the information supplied and may recommend one or more providers based on project type, location, requirements and known provider capability. SiteComms sends the recommendation to the customer; it does not forward the customer&apos;s enquiry or personal information to the provider. T3 Labs is not currently paid a referral commission or placement fee for recommending providers to SiteComms users. <em>(True as at the date of this page. If referral fees, sponsored placements or other material commercial arrangements are introduced later, this disclosure will be updated before those arrangements affect the site.)</em>
      </p>
