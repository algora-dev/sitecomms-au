  ...
  return (
    <div className="sc-container max-w-3xl py-16 sc-prose">
      ...
      <ol>
        ...
        <li><strong>Ask SiteComms for help.</strong> If you want to progress the project, send us enough information to understand what you need.</li>
