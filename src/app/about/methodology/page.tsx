...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "How SiteComms Australia researches, verifies and labels technical, funding, finance and indicative pricing information.",
  ...
  return (
    <div className="sc-container max-w-3xl py-16 sc-prose">
      ...
      <p className="mt-4 text-lg text-[var(--sc-slate)]">
        SiteComms Australia distinguishes between verified rules, indicative assumptions and formal project information so users can see how much confidence to place in a claim.
      </p>
      ...
      <p>
        The calculator is an indicative planning model. It combines current SiteComms equipment and installation assumptions to show the likely order of magnitude for the modelled scope. It is not a formal quote, a statistical market average or a promise that every product architecture will price the same way. Individual assumptions may be informed by multiple supplier or project sources; we do not treat those inputs as a statistically representative market average unless we explicitly publish the sample and method. Where we later publish benchmarks based on completed projects, we will state the sample, period and limitations separately.
      </p>
