...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "How SiteComms Australia writes, labels, reviews and maintains guidance about communication systems, pricing and funding.",
  ...
  return (
    <div className="sc-container max-w-3xl py-16 sc-prose">
      ...
      <p className="mt-4 text-lg text-[var(--sc-slate)]">
        SiteComms Australia exists to make a technically confusing category easier to understand. The site should be useful enough that a buyer can make a better next decision, while being clear about what is indicative and what still needs professional confirmation.
      </p>
