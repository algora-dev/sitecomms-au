...
const guide = STATE_FUNDING_GUIDES.find(item => item.state === "QLD")!;
export const metadata = buildMetadata({ title: "Queensland PA and Communications Funding Routes", description: guide.description, path: "/funding/queensland" });
