...
const guide = STATE_FUNDING_GUIDES.find(item => item.state === "WA")!;
export const metadata = buildMetadata({ title: "Western Australia PA and Communications Funding Routes", description: guide.description, path: "/funding/western-australia" });
