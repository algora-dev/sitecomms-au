...
export default function SchoolRequirementsPage() {
  return <PlanningArticle path={path} title={title} description={description}>
    ...
    <p>The <Link href="/tools/funding-check">funding page</Link> links the researched state and national pathways and their source limitations. Do not assume a project qualifies because it relates to safety, is installed in a school or is fixed infrastructure. Confirm the pathway and approval sequence before committing expenditure.</p>
