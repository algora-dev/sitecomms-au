...
import { pricingConfig, formatAUD } from "@/lib/pricing/config";
      ...
      <div className="sc-container max-w-4xl py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-relaxed text-[var(--sc-slate)]">
            There is no single installed price because site size, cabling, speaker quantities and functionality vary. The examples below use the same pricing assumptions as the SiteComms calculator so you can see the likely order of magnitude before requesting a formal quote.
          </p>
