...
const faqs = [
  ...
  },
  {
    ...
    a: `The calculator is an indicative planning model. It combines current SiteComms equipment and installation assumptions to show the likely order of magnitude for the modelled scope. It is not a formal quote, a statistical market average or a promise that every product architecture will price the same way. Full detail is on our pricing methodology page at /about/methodology.`,
  },
  {
