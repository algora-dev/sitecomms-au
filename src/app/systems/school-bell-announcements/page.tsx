...
export default function SchoolBellPage() {
  return (
    <div>
      ...
      <p>
        Common scenarios we hear about from Australian schools: the old timer is failing and no longer
      ...
      <h2 id="requirements">What education authorities expect</h2>
      <p>
        ...
        synthesises the relevant education authority design, cabling and funding guidance in one place.
      </p>
      ...
      <ContinuePlanning
        items={[
          ...
          { title: "school funding guide", desc: "How school communications upgrades may fit the school property funding process.", href: "/tools/funding-check" },
        ]}
      />
