        ...
        <div className="sc-container py-16">
          <Reveal>
            ...
            <p className="mt-3 max-w-3xl text-lg text-[var(--sc-slate)]">
              SiteComms covers site-wide paging, scheduled bells and messages, emergency communication, fixed intercoms, indoor and outdoor speakers, and the infrastructure that connects them.
            </p>
