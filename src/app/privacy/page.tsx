...
export const metadata: Metadata = buildMetadata({
  title: "Privacy",
  description: "How SiteComms Australia collects and uses information submitted through project, pricing, funding and finance enquiry forms.",
  path: "/privacy",
});
  ...
  return (
    <div className="sc-container max-w-3xl py-16 sc-prose">
      ...
      <p className="mt-4 text-lg text-[var(--sc-slate)]">
        SiteComms Australia collects information that you choose to submit through this website, including project, pricing,
      ...
      <ul>
        ...
        <li>improve SiteComms tools and content.</li>
      </ul>
      <h2>Provider recommendations</h2>
      <p>
        SiteComms does not send your enquiry, contact details, project information, uploaded files or tool answers to
      ...
      <p>
        SiteComms may use third-party services to operate the website, including hosting, email delivery and database
        services. Those services may process information on SiteComms&apos; behalf for the purpose of operating the
      ...
      <p>
        You can ask SiteComms to provide access to personal information held about you, or request that incorrect
      ...
      <p>
        <strong>SiteComms Australia</strong>
        <br />
