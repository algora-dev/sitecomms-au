    ...
    return (
      <div ref={resultRef} className="scroll-mt-6">
        ...
        <div className="mt-8 sc-card p-6">
          ...
          <p className="mt-3 text-xs text-[var(--sc-slate)]">Your funding-check answers are attached automatically so the SiteComms team can understand the context. Your enquiry stays with SiteComms; we do not send your details or funding-check answers to the providers we recommend. <Link href="/privacy" className="underline">Privacy</Link>.</p>
        </div>
