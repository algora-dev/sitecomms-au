...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Free SiteComms tools: get a ballpark installed system price, find researched funding pathways, or explore finance and leasing.",
  path: "/tools",
});
  ...
  return (
    <div className="sc-container max-w-4xl py-16">
      ...
      <p className="mt-4 max-w-3xl text-lg text-[var(--sc-slate)]">
        Planning tools for the questions that often stop a communications project early: what might it cost, which funding or approval routes to investigate, and is finance or leasing worth exploring?
      </p>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        ...
        <div className="sc-card p-6">
          ...
          <h2 className="mt-2 text-xl font-semibold text-[var(--sc-blue-900)]">Funding Pathway Checker</h2>
          <p className="mt-2 text-[var(--sc-slate)]">
            Choose the state, site, legal applicant and scope. Review selected QLD, NSW, VIC, WA and SA pathways, with national programmes, official evidence, deadlines and no promised eligibility.
          </p>
          <Link href="/tools/funding-check" className="sc-btn-primary mt-5">Find researched pathways</Link>
        </div>
      ...
      <div className="mt-8 rounded-2xl border border-[var(--sc-border)] bg-[var(--sc-blue-50)] p-6">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-[var(--sc-slate)]">
          Start wherever the project is clearest: estimate the likely cost, prepare the applicant and funding questions, or explore finance and leasing. Pricing and finance tools are indicative; funding guidance is a dated, sourced pathway review — not an award or eligibility decision.
        </p>
      </div>
    </div>
  );
