...
/**
 * Site-wide SiteComms project enquiry modal.
 *
 * Enquiries are reviewed by the SiteComms team. SiteComms replies to the
...
const ENQUIRY_PROCESS_COPY =
  "Your enquiry goes to the SiteComms team. We'll review the information you provide to understand what you need, then respond with the provider or providers we think are best suited to help you take the next step.";
        ...
        {done ? (
          <div className="py-8 text-center">
            ...
            <p className="mt-2 text-sm text-[var(--sc-slate)]">
              The SiteComms team will review what you sent and reply with the provider or providers we think are the
          ...
          <>
            ...
            <form onSubmit={submit} className="mt-5 space-y-4">
              ...
              <p className="text-center text-xs leading-relaxed text-[var(--sc-slate)]">
                Your enquiry stays with SiteComms. We use it to respond and identify suitable next steps. We do not
