...
import { schoolPlatforms, schoolUseCases, comparisonSources, conditionalPlatform } from "../src/lib/content/school-compare.ts";
import { CONTENT_META } from "../src/lib/content-meta.ts";
assert.equal(schoolPlatforms.length,7);
...
assert.match(conditionalPlatform.summary,/not verified|not been verified|not established|unverified/i);
const research=JSON.parse(readFileSync(new URL("../docs/comparison-research.json",import.meta.url),"utf8"));
assert.equal(research.reviewed,"2026-09-19");
