...
const pricingUrl = new URL(careExamplePricingHref(), "https://sitecomms.au");
...
const financeUrl = new URL(buildIndustryToolHref("/tools/finance-check", { industry: "aged-care", source: "pricing", estimate }), "https://sitecomms.au");
